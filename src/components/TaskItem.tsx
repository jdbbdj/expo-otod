...
import {Box, useTheme,HStack,Text, themeTools, useColorModeValue} from 'native-base'
...
const TaskItem = (props:Props) =>{
    ...
    return (<HStack alignItems='center' w='full' px={4} py={2} bg={useColorModeValue('warmGray.50','primary.900')}>
