...
import Animated,{Easing,useSharedValue,useAnimatedStyle,withTiming,withDelay,interpolateColor, withSequence} from 'react-native-reanimated'
...
const AnimatedTaskLabel = memo((props:Props)=>{
    const {strikeTrough,textColor,inactiveTextColor,onPress,children} = props
    ...
    const textColorAnimatedStyles = useAnimatedStyle(
        ...
        [strikeTrough,textColor,inactiveTextColor]
    )
